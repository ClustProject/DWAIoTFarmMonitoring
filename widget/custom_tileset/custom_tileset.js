...
function setTitle() {
  self.ctx.custom.$widgetIcon.html(self.ctx.widget.config.titleIcon);
  self.ctx.custom.$widgetIcon.css({
    color: self.ctx.widget.config.iconColor,
    fontSize: self.ctx.widget.config.iconSize,
  });
  ...
  if (label.includes('퀀텀')) {
    let $svg = $(`<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
        <g id="그룹_164509" data-name="그룹 164509" transform="translate(-1119 -576)">
          <g id="사각형_148805" data-name="사각형 148805" transform="translate(1119 576)" fill="#fff" stroke="#f2711c" stroke-width="1">
    ...
    let $svg = $(`<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
        <g id="그룹_164513" data-name="그룹 164513" transform="translate(-1018 -427)">
          <g id="사각형_148810" data-name="사각형 148810" transform="translate(1018 427)" fill="#e7f2fa" stroke="#2185d0" stroke-width="1">
            <rect width="60" height="60" rx="2" stroke="none"/>
            <rect x="0.5" y="0.5" width="59" height="59" rx="1.5" fill="none"/>
          </g>
          <path id="layers_FILL0_wght200_GRAD0_opsz40" d="M20,31.083,7.708,21.542l1.125-.917L20,29.292l11.167-8.667,1.125.917Zm0-5.75L7.708,15.792,20,6.25l12.292,9.542ZM20,15.542Zm0,8,10-7.75L20,8.083,10,15.792Z" transform="translate(1028.292 438.75)" fill="#2185d0"/>
        </g>
      </svg>
      `);
